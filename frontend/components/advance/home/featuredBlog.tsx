          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-12">
                <div className="card card-profile overflow-hidden z-index-2 p-2 rounded-2">
                  <Carousel
                    id={"blogArticles"}
                    height={ROW_HEIGHT}
                    showIndicators
                  >
                    {(articles?.data || []).map((item, itemIndex) => {
                      const { title, slug, description, image } =
                        item?.attributes ?? {}
                      return (
                        <CarouselItem key={slug} active={itemIndex === 0}>
                          <div
          ...
          <div className="container">
            <div className="row mx-auto mb-4 text-center">
              <div className="col-lg-12">
                <Swiper id="bannerBlogAds" height={150} slidesPerView={5}>
